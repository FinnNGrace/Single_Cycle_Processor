...
module ctrl_unit_tb;
	...
	initial begin
	   ...
	   (op_b_sel == 1'b1) && (mem_wren == 1'b0) && (alu_op == 4'b0) && (wb_sel == 2'b0)) $display("PASSED"); 
      ...
      assert ((br_sel == 1'b0) && (rd_wren == 1'b1) && (br_unsigned == 1'b0) && (op_a_sel == 1'b1) &&
	   ...
	   (op_b_sel == 1'b0) && (mem_wren == 1'b0) && (alu_op == 4'b0) && 
      ...
      #2
	   ...
	   (op_b_sel == 1'b1) && (mem_wren == 1'b0) && (alu_op == 4'b0)  &&
		...
		#1
		assert ((br_sel == 1'b0) && (rd_wren == 1'b0) && (br_unsigned == 1'b0) && (op_a_sel == 1'b0) &&
	   (op_b_sel == 1'b1) && (mem_wren == 1'b1) && (alu_op == 4'b0)  &&
		(wb_sel == 2'b0)) $display("PASSED"); 
		else $error("Assertion failed"); //test 4 cases when br_less and br_equal are "don't care"
		#2
		br_less = 1'b1;
	   ...
	   (op_b_sel == 1'b1) && (mem_wren == 1'b0) && (alu_op == 4'b0) &&
		...
		#1
		assert ((br_sel == 1'b0) && (rd_wren == 1'b1) && (br_unsigned == 1'b0) && (op_a_sel == 1'b0) &&
	   (op_b_sel == 1'b1) && (mem_wren == 1'b0) && (alu_op == 4'b10)  && 
		(wb_sel == 2'b0)) $display("PASSED"); 
		else $error("Assertion failed"); //test 4 cases when br_less and br_equal are "don't care"
		#2
		br_less = 1'b1;
		...
		#1
		assert ((br_sel == 1'b0) && (rd_wren == 1'b1) && (br_unsigned == 1'b0) && (op_a_sel == 1'b0) &&
	   (op_b_sel == 1'b1) && (mem_wren == 1'b0) && (alu_op == 4'b011)  &&
		(wb_sel == 2'b0)) $display("PASSED"); 
		else $error("Assertion failed"); //test 4 cases when br_less and br_equal are "don't care"
		#2
		br_less = 1'b1;
		...
		#1
		assert ((br_sel == 1'b0) && (rd_wren == 1'b1) && (br_unsigned == 1'b0) && (op_a_sel == 1'b0) &&
	   (op_b_sel == 1'b1) && (mem_wren == 1'b0) && (alu_op == 4'b100) &&
		(wb_sel == 2'b0)) $display("PASSED"); 
		else $error("Assertion failed"); //test 4 cases when br_less and br_equal are "don't care"
		#2
		br_less = 1'b1;
		...
		#1
		assert ((br_sel == 1'b0) && (rd_wren == 1'b1) && (br_unsigned == 1'b0) && (op_a_sel == 1'b0) &&
	   (op_b_sel == 1'b1) && (mem_wren == 1'b0) && (alu_op == 4'b101) &&
		(wb_sel == 2'b0)) $display("PASSED"); 
		else $error("Assertion failed"); //test 4 cases when br_less and br_equal are "don't care"
		#2
		br_less = 1'b1;
		...
		#1
		assert ((br_sel == 1'b0) && (rd_wren == 1'b1) && (br_unsigned == 1'b0) && (op_a_sel == 1'b0) &&
	   (op_b_sel == 1'b1) && (mem_wren == 1'b0) && (alu_op == 4'b110) &&
		(wb_sel == 2'b0)) $display("PASSED"); 
		else $error("Assertion failed"); //test 4 cases when br_less and br_equal are "don't care"
	   #2
		br_less = 1'b1;
		...
		#1
		assert ((br_sel == 1'b0) && (rd_wren == 1'b1) && (br_unsigned == 1'b0) && (op_a_sel == 1'b0) &&
	   (op_b_sel == 1'b1) && (mem_wren == 1'b0) && (alu_op == 4'b111) &&
		(wb_sel == 2'b0)) $display("PASSED"); 
		else $error("Assertion failed"); //test 4 cases when br_less and br_equal are "don't care"
		#2
		br_less = 1'b1;
		...
		#1
		assert ((br_sel == 1'b0) && (rd_wren == 1'b1) && (br_unsigned == 1'b0) && (op_a_sel == 1'b0) &&
	   (op_b_sel == 1'b1) && (mem_wren == 1'b0) && (alu_op == 4'b1000) &&
		(wb_sel == 2'b0)) $display("PASSED"); 
		else $error("Assertion failed"); //test 4 cases when br_less and br_equal are "don't care"
		#2
		br_less = 1'b1;
		...
		#1
		assert ((br_sel == 1'b0) && (rd_wren == 1'b1) && (br_unsigned == 1'b0) && (op_a_sel == 1'b0) &&
	   (op_b_sel == 1'b1) && (mem_wren == 1'b0) && (alu_op == 4'b1001) &&
		(wb_sel == 2'b0)) $display("PASSED"); 
		else $error("Assertion failed"); //test 4 cases when br_less and br_equal are "don't care"
		#2
		br_less = 1'b1;
	   ...
	   (op_b_sel == 1'b0) && (mem_wren == 1'b0) && (alu_op == 4'b0) &&
		...
		#1
		assert ((br_sel == 1'b0) && (rd_wren == 1'b1) && (br_unsigned == 1'b0) && (op_a_sel == 1'b0) &&
	   (op_b_sel == 1'b0) && (mem_wren == 1'b0) && (alu_op == 4'b1) &&
		(wb_sel == 2'b0)) $display("PASSED"); 
		else $error("Assertion failed"); //test 4 cases when br_less and br_equal are "don't care"
		#2
		br_less = 1'b1;
		...
		#1
		assert ((br_sel == 1'b0) && (rd_wren == 1'b1) && (br_unsigned == 1'b0) && (op_a_sel == 1'b0) &&
	   (op_b_sel == 1'b0) && (mem_wren == 1'b0) && (alu_op == 4'b10) &&
		(wb_sel == 2'b0)) $display("PASSED"); 
		else $error("Assertion failed"); //test 4 cases when br_less and br_equal are "don't care"
		#2
		br_less = 1'b1;
		...
		#1
		assert ((br_sel == 1'b0) && (rd_wren == 1'b1) && (br_unsigned == 1'b0) && (op_a_sel == 1'b0) &&
	   (op_b_sel == 1'b0) && (mem_wren == 1'b0) && (alu_op == 4'b011) &&
		(wb_sel == 2'b0)) $display("PASSED"); 
		else $error("Assertion failed"); //test 4 cases when br_less and br_equal are "don't care"
		#2
		br_less = 1'b1;
		...
		#1
		assert ((br_sel == 1'b0) && (rd_wren == 1'b1) && (br_unsigned == 1'b0) && (op_a_sel == 1'b0) &&
	   (op_b_sel == 1'b0) && (mem_wren == 1'b0) && (alu_op == 4'b100) &&
		(wb_sel == 2'b0)) $display("PASSED"); 
		else $error("Assertion failed"); //test 4 cases when br_less and br_equal are "don't care"
		#2
		br_less = 1'b1;
		...
		#1
		assert ((br_sel == 1'b0) && (rd_wren == 1'b1) && (br_unsigned == 1'b0) && (op_a_sel == 1'b0) &&
	   (op_b_sel == 1'b0) && (mem_wren == 1'b0) && (alu_op == 4'b101) &&
		(wb_sel == 2'b0)) $display("PASSED"); 
		else $error("Assertion failed"); //test 4 cases when br_less and br_equal are "don't care"
		#2
		br_less = 1'b1;
		...
		#1
		assert ((br_sel == 1'b0) && (rd_wren == 1'b1) && (br_unsigned == 1'b0) && (op_a_sel == 1'b0) &&
	   (op_b_sel == 1'b0) && (mem_wren == 1'b0) && (alu_op == 4'b110) &&
		(wb_sel == 2'b0)) $display("PASSED"); 
		else $error("Assertion failed"); //test 4 cases when br_less and br_equal are "don't care"
		#2
		br_less = 1'b1;
		...
		#1
		assert ((br_sel == 1'b0) && (rd_wren == 1'b1) && (br_unsigned == 1'b0) && (op_a_sel == 1'b0) &&
	   (op_b_sel == 1'b0) && (mem_wren == 1'b0) && (alu_op == 4'b111)  &&
		(wb_sel == 2'b0)) $display("PASSED"); 
		else $error("Assertion failed"); //test 4 cases when br_less and br_equal are "don't care"
		#2
		br_less = 1'b1;
		...
		#1
		assert ((br_sel == 1'b0) && (rd_wren == 1'b1) && (br_unsigned == 1'b0) && (op_a_sel == 1'b0) &&
	   (op_b_sel == 1'b0) && (mem_wren == 1'b0) && (alu_op == 4'b1000) &&
		(wb_sel == 2'b0)) $display("PASSED"); 
		else $error("Assertion failed"); //test 4 cases when br_less and br_equal are "don't care"
		#2
		br_less = 1'b1;
		...
		#1
		assert ((br_sel == 1'b0) && (rd_wren == 1'b1) && (br_unsigned == 1'b0) && (op_a_sel == 1'b0) &&
	   (op_b_sel == 1'b0) && (mem_wren == 1'b0) && (alu_op == 4'b1001) &&
		(wb_sel == 2'b0)) $display("PASSED"); 
		else $error("Assertion failed"); //test 4 cases when br_less and br_equal are "don't care"
		#2
		br_less = 1'b1;
